...
local function checkLevelUp(oldPoints, newPoints)
    ...
    if newRankInfo.currentRank > oldRankInfo.currentRank then
        ...
        local rewards = Config.Ranks[newRankInfo.currentRank] and Config.Ranks[newRankInfo.currentRank].rewards or nil
        TriggerEvent('flake_drugselling:rankupNotify', newRankInfo.currentRank, newRankInfo.rankLabel, rewardType, rewards)
    end
end
